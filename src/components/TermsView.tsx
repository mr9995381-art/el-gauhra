        ...
        <div className="bg-white dark:bg-slate-950 p-8 sm:p-12 rounded-3xl border border-slate-100 dark:border-slate-800 shadow-xl">
          ...
          <div className="space-y-6 text-slate-600 dark:text-slate-300 text-sm sm:text-base">
            ...
            <h2 className="text-xl font-bold text-slate-800 dark:text-slate-100 pt-4 border-t border-slate-100 dark:border-slate-800">
              1. سياسة الاستخدام الفردي للجهاز (منع مشاركة الحساب)
            </h2>
            <p className="font-bold text-slate-800 dark:text-slate-100">
              يُحظر تماماً مشاركة بيانات تسجيل الدخول الخاصة بك مع أي شخص آخر أو فتح الحساب من عدة أجهزة في نفس الوقت.
            </p>
            <p>
              قامت المنصة بتطبيق نظام أمان ذكي يفحص جلسات الأجهزة النشطة تلقائياً. في حال تم كشف استخدام متزامن أو فتح الحساب على أكثر من جهاز في آن واحد، سيقوم النظام تلقائياً بإنهاء الجلسات الأخرى وقد يتعرض الحساب للإيقاف المؤقت أو الدائم دون استرداد قيمة الاشتراك.
            </p>
