        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
          <div className="space-y-6">
            ...
            <p className="text-slate-600 dark:text-slate-400 leading-relaxed text-base">
              مستر عبدالله سيد، خبير تدريس اللغة الإنجليزية للمراحل الابتدائية والإعدادية والثانوية في جمهورية مصر العربية. على مدار أكثر من 10 سنوات، قام مستر عبدالله بتمكين آلاف الطلاب من اجتياز الامتحانات بتفوق منقطع النظير، وبناء أساس لغوي قوي يساعدهم في مستقبلهم الجامعي والمهني.
            </p>
            <p className="text-slate-600 dark:text-slate-400 leading-relaxed text-base">
